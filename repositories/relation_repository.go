...
func (r *relationRepository) FindUserFollowings(ctx context.Context, userId uint) (result []*models.Relation, err error) {
...
func (r *relationRepository) FindUserFollowers(ctx context.Context, userId uint) (result []*models.Relation, err error) {
...
func (r *relationRepository) findUserRelation(ctx context.Context, query queries.GoQuery, userId uint) (result []*models.Relation, err error) {
